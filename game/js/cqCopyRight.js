...
+'			<a href="#" target="_blank" title="《xxx》" ><img src="images/bomlogo.png"></a>'
+'		</div>'
...
//公司统一的版权号
+'			<p>'
+'				<span class="SDGCOPYRIGHT-pr3">All rights reserved.  xxx  版权所有 本游戏由【xxx网络公司】开发运营  </span>'
+'			</p>'
+'			<p class="SDGCOPYRIGHT-sdlogo">'
+'				<span class="SDGCOPYRIGHT-pr3">本网站设计及美工由<a href="http://www.925ps.com/" target="_blank" title="925ps设计" >925ps设计工作室</a>独家设计制作，本工作室只做网站设计，不参与游戏运营，玩家勿扰。</span>'
+'			</p>'
+'		</div>'
//右侧网络警察3个图标
+'		<div class="SDGCOPYRIGHT-priv">'
+'			<span>'
+'              <a href="http://www.925ps.com/" target="_blank" title="高端传奇网站模板设计"><img src="images/925ps.png" border=0 width="50" height="50"></a>'
+'			</span>'
+'		</div>'
